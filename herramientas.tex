...
% uno de los objetivos fundamentos de esta herramienta se encue
...
Si bien estos segmentos son muy importantes para la función de reconocimiento, en esta sección nos enfocamos en quitarlas por motivos estructurales.
...
La formación de agregados es una forma especial de interacciones con 
...
% Sin embargo, la formación de agregados puede afectar, también a los módulos unidos por el linker.
...
% Utilizando esta herramienta se identifican los residuos que favorecen la formación de una estructura estable y se los marca como posibles objetivos para la siguiente ronda 
% de mutaciones del algoritmo, llevando a la secuencia global hacia un perfil estructuralmente flexible y desordenado, con pocas posibilidades de desarrollar una función.
% 
% % EJEMPLO
%   
