...
Por definición, las proteínas están compuestas por cadenas lineales formadas por cualquier combinación de aminoácidos.
...
% Por ejemplo, en la figura se muestra el perfil resultante en base a las propiedades conformacionales de las proteínas.
%   
% Como ejemplo de esto podemos ver, en el gráfico \ref{aggregationDiagram}, un esquema de las propiedades conformacionales de las proteínas naturales. 
% Las proteínas adoptan una gran diversidad de estructuras y las propiedades conformacionales de éstas(flexibilidad, )
% 
% 
...
La pregunta mas importante, entonces, es cuales son las funciones fisiológica que cumplen las IDPs y como es su mecanismo funcional.
...
Un paso importante en para entender esto es la clasificación de las IDPs conocidas de acuerdo a sus funcionalidades\cite{van2014classification}.
...
De esta clasificacion se puede ver que las funcionalidades en IDRs/IDPs emergen a partir del propio desorden intrínseco o mediante mecanismos de reconocimiento molecular(interacciones transitivas o permanentes).
...
En el segundo caso, el mecanismo generalmente implica el plegamiento para adquirir una estructura ordenada al interaccionar con el ligando.
Esta estrategia de reconocimiento es básicamente diferente a la que adoptan los dominios globulares. 
...
en IDPs el mecanismo de unión \textit{binding} es principalmente mediado por elementos(motivos) cortos de reconocimiento\cite{neduva2005systematic,fuxreiter2007local}, caracterizados por su naturaleza flexible, lo que 
